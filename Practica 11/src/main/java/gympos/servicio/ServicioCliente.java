...
public class ServicioCliente {
    ...
    public Cliente GetPorId(int id) throws ClienteNoEncontradoException {
        return clientes.stream().filter(c -> c.GetId() == id).findFirst().orElseThrow(() -> new ClienteNoEncontradoException(id));
    }

    public void Agregar(String nombre, String apellido, String correo, String telefono) throws ValidacionException {
    ...
    public void Actualizar(int id, String nombre, String apellido, String correo, String telefono) throws ClienteNoEncontradoException, ValidacionException {
        Validar(nombre, apellido, correo, telefono);
    ...
    private void Validar(String nombre, String apellido, String correo, String telefono) throws ValidacionException {
